          ...
          <div class="col-lg-9 col-md-12 col-sm-12">
            ...
            <div class="card border rounded-3 p-4 bg-white shadow-sm mb-4">
              <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                <div>
                  <h4 class="fw-bold mb-1 text-dark"><i class="bi bi-journal-check text-warning me-2"></i>Gestion des Devoirs & Travaux</h4>
                  <p class="text-muted small mb-0">Donnez des devoirs à vos apprenants, fixez la note minimum et maximum, et évaluez leurs soumissions.</p>
                </div>
            ...
            <div v-else-if="courses.length === 0" class="card border rounded-3 p-5 text-center bg-white shadow-sm">
              ...
              <p class="text-muted">Vous n'avez pas encore créé de cours. Veuillez créer un cours pour donner des devoirs.</p>
            ...
            <div v-else-if="selectedCourseId">
              <AssignmentManager :key="selectedCourseId" :course-id="selectedCourseId" />
            </div>
          </div>
        </div>
      </div>
