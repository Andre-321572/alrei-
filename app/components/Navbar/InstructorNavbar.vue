            ...
            <nav id="navigation" :class="isMobile ? 'navigation navigation-portrait' : 'navigation navigation-landscape'">
                ...
                <div :class="['nav-menus-wrapper', { 'nav-menus-wrapper-open': toggle }]">
                    ...
                    <ul class="nav-menu">
                        ...
                        <li :class="['/instructor-dashboard','/instructor-courses','/instructor-create-course','/instructor-course-added','/instructor-students','/instructor-reviews','/student-dashboard','/student-subscription','/student-course-resume','/student-wishlist','/student-payment-info','/profile-edit','/settings','/delete-account'].includes(current) ? 'active' : ''">
...
const { user, isAuthenticated, isInstructor, isStudent, isAdmin, logout } = useAuth()
