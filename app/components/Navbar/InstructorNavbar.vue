                    ...
                    <ul class="nav-menu">
                        ...
                        <li v-if="!isInstructor && !isAdmin" :class="['/grid-with-sidebar','/grid-with-sidebar-2','/grid-with-sidebar-3','/list-with-sidebar','/full-width-course','/full-width-course-2','/full-width-course-3','/full-width-course-4','/detail','/detail-2','/detail-3','/detail-4','/detail-5','/detail-6','/find-instructor','/instructor-detail'].includes(current) ? 'active' : ''">
                            ...
                            <ul class="nav-dropdown ">
                                ...
                                <li :class="['/detail'].includes(current) ? 'active' : ''"><a href="#">{{ $t('courses_detail') }}<span class=""><span class=''></span></span></a>
                                    <ul class="nav-dropdown nav-submenu">
                        ...
                        <li v-if="!isAdmin" :class="['/about-us','/blog','/blog-detail','/pricing','/register','/component','/contact','/privacy','/faq','/shop-full-width','/shop-left-sidebar','/shop-right-sidebar','/product-detail','/add-to-cart','/product-wishlist','/checkout','/shop-order'].includes(current) ? 'active' : ''">
                            <a href="#">
                        ...
                        <li :class="['/instructor-dashboard','/instructor-courses','/instructor-create-course','/instructor-course-added','/instructor-earning','/instructor-students','/instructor-orders','/instructor-reviews','/instructor-payout','/student-dashboard','/student-subscription','/student-course-resume','/student-wishlist','/student-payment-info','/profile-edit','/settings','/delete-account'].includes(current) ? 'active' : ''">
                            ...
                            <ul class="nav-dropdown nav-submenu">
                                ...
                                <li v-if="isAdmin" :class="current === '/admin-dashboard' ? 'active' : ''">
                                     <NuxtLink to="/admin-dashboard">
                                         <i class="bi bi-shield-lock me-2"></i>{{ $t('administration') }}
                                     </NuxtLink>
                                 </li>
