            ...
            <nav id="navigation" :class="isMobile ? 'navigation navigation-portrait' : 'navigation navigation-landscape'">
                <div class="nav-header">
                    <NuxtLink class="nav-brand static-logo" to="/">
                        <img :src="logoLight" class="logo" alt="" style="height:45px;width:auto;" />
                    </NuxtLink>
                        ...
                        <div class="login-form">
                            <form>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-main full-width fw-medium py-3">{{ $t('sign_in') }}</button>
                                </div>
                                
                                <div class="loginbox-footer text-center mt-3">
                                    {{ $t('dont_have_account') }} <NuxtLink to="/register" class="text-main fw-medium ms-1">{{ $t('sign_up') }}</NuxtLink>
                                </div>
