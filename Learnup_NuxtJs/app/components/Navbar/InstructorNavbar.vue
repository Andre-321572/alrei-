                                        ...
                                        <div class="dropdown-header py-3 border-bottom">
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar-flex">
                                                    <div class="square--50 circle"><img :src="avatar3" class="img-fluid circle" alt=""></div>
                                                </div>
                                                <div class="caps d-flex flex-column gap-1">
                                                    <h6 class="fw-semibold m-0">Adam L. Markram</h6>
                                                    <span class="text-mid text-muted-2">Figma Designer, Developer</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="dropdown-body">
                                            <ul>
                                                <li><NuxtLink to="/instructor-dashboard" :class="current === '/instructor-dashboard' ? 'active' : ''"><i class="bi bi-ui-radios-grid"></i>{{ $t('dashboard') }}</NuxtLink></li>
                                                <li><NuxtLink to="/instructor-courses" :class="current === '/instructor-courses' ? 'active' : ''"><i class="bi bi-basket2"></i>{{ $t('courses') }}</NuxtLink></li>
                                                <li><NuxtLink to="/instructor-create-course" :class="current === '/instructor-create-course' ? 'active' : ''"><i class="bi bi-patch-plus"></i>{{ $t('create_course') }}</NuxtLink></li>
                                                <li><NuxtLink to="/instructor-earning" :class="current === '/instructor-earning' ? 'active' : ''"><i class="bi bi-coin"></i>{{ $t('earning') }}</NuxtLink></li>
                                                <li><NuxtLink to="/instructor-students" :class="current === '/instructor-students' ? 'active' : ''"><i class="bi bi-people"></i>{{ $t('students') }}</NuxtLink></li>
                                                <li><NuxtLink to="/instructor-orders" :class="current === '/instructor-orders' ? 'active' : ''"><i class="bi bi-bag-check"></i>{{ $t('my_orders') }}</NuxtLink></li>
                                                <li><NuxtLink to="/instructor-reviews" :class="current === '/instructor-reviews' ? 'active' : ''"><i class="bi bi-star-half"></i>{{ $t('reviews') }}</NuxtLink></li>
                                                <li><NuxtLink to="/instructor-payout" :class="current === '/instructor-payout' ? 'active' : ''"><i class="bi bi-wallet2"></i>{{ $t('payout') }}</NuxtLink></li>
                                                <li><a href="#"><i class="bi bi-question-octagon"></i>{{ $t('help_support') }}</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                ...
                <div :class="['nav-menus-wrapper', { 'nav-menus-wrapper-open': toggle }]">
                    ...
                    <ul class="nav-menu">
                        ...
                        <li :class="['/', '/home-2', '/home-3', '/home-4', '/home-5', '/home-6', '/home-7', '/home-8', '/home-9', '/home-10', '/new-home-1', '/new-home-2', '/new-home-3'].includes(current) ? 'active' : ''">
                            ...
                            <ul class="nav-dropdown nav-submenu">
                                <li :class="current === '/' ? 'active' : ''"><NuxtLink to="/">{{ $t('home_layout') }} 01</NuxtLink></li>
                                <li :class="current === '/home-2' ? 'active' : ''"><NuxtLink to="/home-2">{{ $t('home_layout') }} 02</NuxtLink></li>
                                <li :class="current === '/home-3' ? 'active' : ''"><NuxtLink to="/home-3">{{ $t('home_layout') }} 03</NuxtLink></li>
                                <li :class="current === '/home-4' ? 'active' : ''"><NuxtLink to="/home-4">{{ $t('home_layout') }} 04</NuxtLink></li>
                                <li :class="current === '/home-5' ? 'active' : ''"><NuxtLink to="/home-5">{{ $t('home_layout') }} 05</NuxtLink></li>
                                <li :class="current === '/home-6' ? 'active' : ''"><NuxtLink to="/home-6">{{ $t('home_layout') }} 06</NuxtLink></li>
                                <li :class="current === '/home-7' ? 'active' : ''"><NuxtLink to="/home-7">{{ $t('home_layout') }} 07</NuxtLink></li>
                                <li :class="current === '/home-8' ? 'active' : ''"><NuxtLink to="/home-8">{{ $t('home_layout') }} 08</NuxtLink></li>
                                <li :class="current === '/home-9' ? 'active' : ''"><NuxtLink to="/home-9">{{ $t('home_layout') }} 09</NuxtLink></li>
                                <li :class="current === '/home-10' ? 'active' : ''"><NuxtLink to="/home-10">{{ $t('home_layout') }} 10</NuxtLink></li>
                                <li :class="current === '/new-home-1' ? 'active' : ''"><NuxtLink to="/new-home-1">{{ $t('home_layout') }} 11</NuxtLink></li>
                                <li :class="current === '/new-home-2' ? 'active' : ''"><NuxtLink to="/new-home-2">{{ $t('home_layout') }} 12</NuxtLink></li>
                                <li :class="current === '/new-home-3' ? 'active' : ''"><NuxtLink to="/new-home-3">{{ $t('home_layout') }} 13</NuxtLink></li>
                            </ul>
                        </li>
                        
                        <li :class="['/grid-with-sidebar','/grid-with-sidebar-2','/grid-with-sidebar-3','/list-with-sidebar','/full-width-course','/full-width-course-2','/full-width-course-3','/full-width-course-4','/detail','/detail-2','/detail-3','/detail-4','/detail-5','/detail-6','/find-instructor','/instructor-detail'].includes(current) ? 'active' : ''">
                            <a href="#">
                        ...
                        <li :class="['/about-us','/blog','/blog-detail','/pricing','/404','/register','/component','/contact','/privacy','/faq','/shop-full-width','/shop-left-sidebar','/shop-right-sidebar','/product-detail','/add-to-cart','/product-wishlist','/checkout','/shop-order'].includes(current) ? 'active' : ''">
                            <a href="#">
                        ...
                        <li :class="['/instructor-dashboard','/instructor-courses','/instructor-create-course','/instructor-course-added','/instructor-earning','/instructor-students','/instructor-orders','/instructor-reviews','/instructor-payout','/student-dashboard','/student-subscription','/student-course-resume','/student-wishlist','/student-payment-info','/profile-edit','/settings','/delete-account'].includes(current) ? 'active' : ''">
                            <a href="#">
                                {{ $t('accounts') }}<span class="submenu-indicator"><span class='submenu-indicator-chevron'></span></span>
                            </a>
                            <ul class="nav-dropdown nav-submenu">
                                <li :class="['/instructor-dashboard','/instructor-courses','/instructor-create-course','/instructor-course-added','/instructor-earning','/instructor-students','/instructor-orders','/instructor-reviews','/instructor-payout'].includes(current) ? 'active' : ''"><a href="#"><i class="bi bi-person-check me-2"></i>{{ $t('instructor_dashboard') }}<span class="submenu-indicator"><span class='submenu-indicator-chevron'></span></span></a>
                                    <ul class="nav-dropdown nav-submenu">
                                ...
                                <li :class="['/student-dashboard','/student-subscription','/student-course-resume','/student-wishlist','/student-payment-info'].includes(current) ? 'active' : ''"><a href="#"><i class="bi bi-mortarboard me-2"></i>{{ $t('student_dashboard') }}<span class="submenu-indicator"><span class='submenu-indicator-chevron'></span></span></a>
                                    <ul class="nav-dropdown nav-submenu">
                    ...
                    <ul class="nav-menu nav-menu-social align-to-right">
                        ...
                        <li class="become-tutor">
                            <NuxtLink to="/instructor-create-course"><i class="bi bi-patch-plus-fill"></i>{{ $t('create_course') }}</NuxtLink>
                        </li>
                        <li>
                            <div class="btn-group account-drop">
                                <button type="button" class="btn btn-order-by-filt border-0" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu pull-right animated flipInX box-shadow-sm">
                                    ...
                                    <div class="dropdown-body">
                                        <ul>
                                            <li><NuxtLink to="/instructor-dashboard" :class="current === '/instructor-dashboard' ? 'active' : ''"><i class="bi bi-ui-radios-grid"></i>Dashboard</NuxtLink></li>
                                            <li><NuxtLink to="/instructor-courses" :class="current === '/instructor-courses' ? 'active' : ''"><i class="bi bi-basket2"></i>Courses</NuxtLink></li>
                                            <li><NuxtLink to="/instructor-create-course" :class="current === '/instructor-create-course' ? 'active' : ''"><i class="bi bi-patch-plus"></i>Create Course</NuxtLink></li>
                                            <li><NuxtLink to="/instructor-earning" :class="current === '/instructor-earning' ? 'active' : ''"><i class="bi bi-coin"></i>Earning</NuxtLink></li>
                                            <li><NuxtLink to="/instructor-students" :class="current === '/instructor-students' ? 'active' : ''"><i class="bi bi-people"></i>Students</NuxtLink></li>
                                            <li><NuxtLink to="/instructor-orders" :class="current === '/instructor-orders' ? 'active' : ''"><i class="bi bi-bag-check"></i>My Orders</NuxtLink></li>
                                            <li><NuxtLink to="/instructor-reviews" :class="current === '/instructor-reviews' ? 'active' : ''"><i class="bi bi-star-half"></i>Reviews</NuxtLink></li>
                                            <li><NuxtLink to="/instructor-payout" :class="current === '/instructor-payout' ? 'active' : ''"><i class="bi bi-wallet2"></i>Payout</NuxtLink></li>
                                            <li><a href="#"><i class="bi bi-question-octagon"></i>Help & Support</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form>
                                ...
                                <div class="form-group mb-4">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="forget-password"><a href="#" class="text-decoration-underline">Forgot Password?</a></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="text-center text-muted">Don't have an account yet? <a href="#" data-bs-toggle="modal" data-bs-target="#signup" data-bs-dismiss="modal" class="fw-semibold">Sign Up</a></div>
                                </div>
                    ...
                    <div class="login-card">
                        ...
                        <div class="login-form">
                            <form>
                                ...
                                <div class="form-group mb-3">
                                    <div class="row g-3">
                                        <div class="form-group col-6"><input type="email" class="form-control" placeholder="First Name"></div>
                                        <div class="form-group col-6"><input type="email" class="form-control" placeholder="Last Name"></div>
                                    </div>
                                </div>
