                    ...
                    <div class="breadcrumb m-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb simple light">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Course List Layout</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="pageTitle-wrap">
                        <h1 class="text-light">Courses List Layout</h1>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-md-7">
                                        <div class="card-body">
                                            ...
                                            <ul class="list-inline mb-3">
                                                ...
                                                <li class="list-inline-item text-muted mb-1 mb-sm-0"><i class="fas fa-table text-orange me-2"></i>{{item.lectures}} lectures</li>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="btn-wraps">
                                                    <a href="#" class="btn btn-md btn-dark">View more</a>    
                                                </div>                  
                                            </div>
                                        </div>
                                    </div>
