                                        ...
                                        <table class="table align-middle p-4 mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                >
                                                        ...
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div class="courses-info">
                                                                ...
                                                                <div class="d-flex gap-2">
                                                                    <p class="mb-0 text-muted-2 me-1"><i class="bi bi-camera-video me-1"></i>{{item.lectures}} lectures</p>
                                                                    <p class="mb-0 text-muted-2"><i class="bi bi-check-circle-fill text-success me-1"></i>{{item.completed}} Completed</p>
                                                                </div>
                                                            </div>
                                                            
                                                        </div>
                                                    </td>
                                                    <td><span class="text-muted-2">{{item.enrolled}}</span></td>
                                                    
                                                    <td>
                                                        <span v-if="item.status === 'Live'"
                                                            class="badge bg-light-green text-green"
                                                        >
                                                            Live
                                                        </span>
                                                        <span v-else-if="item.status === 'Rejected'"
                                                            class="badge bg-light-red text-red"
                                                        >
                                                            Rejected
                                                        </span>
                                                        <span v-else-if="item.status === 'Disable'"
                                                    ...
                                                    <td>
                                                        <span class="text-muted-2">${{item.price}}</span>
                                                    </td>
                                                    <td>
...
import { courseData } from '@/data/instructor.js'
